...
const Footer = () => {
    return (
        <footer className="fixed bottom-0 left-0 z-20 w-full p-5 bg-white border-t border-gray-200 shadow md:flex md:items-center md:justify-between md:p-5 dark:bg-gray-800 dark:border-gray-600">
